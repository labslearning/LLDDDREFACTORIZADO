...
INSTALLED_APPS = [
    ...
    'tasks.apps.TasksConfig', # App Legacy (Monolito)
    
    # ==============================================
    # 🦄 UNICORN ARCHITECTURE (NUEVOS DOMINIOS)
    # ==============================================
    'apps.academics',
    'apps.wellbeing',
    'apps.social',
...
# 🛡️ CIRUGÍA: Configuración dinámica para soportar SQLite (Local) y Postgres (Prod)
DATABASES = {
    'default': {
